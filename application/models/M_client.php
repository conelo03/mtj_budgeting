...
class M_client extends CI_Model {
	...
	var $order = array('clientId' => 'asc'); // default order 
	...
	public function get_by_id($clientId)
	{
		return $this->db->get_where($this->table, ['clientId' => $clientId])->row_array();
	}
	...
	{
		return $this->db->delete($this->table, ['clientId' => $clientId]);
	}
}
